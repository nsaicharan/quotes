...
<body>
	...
	<div class="container--table">
		...
		<h2 class="text-center">Insurance Listing</h2>
			...
			<tbody>
	   			...
	   			<tr>
					<td class="text-center align-middle">
	   				...
	   				<td class="align-middle"><?php echo $row['insurance']; ?></td>
	   				<td class="text-center align-middle">
						<a title="Edit" class="btn btn-primary btn-sm mr-1" href="quickedit.php?id=<?php echo $row['id']; ?>"><i class="fa  fa-pencil"></i></a><button title="Delete" class="deleteBtn btn btn-danger btn-sm ml-1" data-id="<?php echo $row['id']; ?>"><i class="fa fa-trash-o"></i></button>
					</td>
	   			</tr>
  ...
  <script>
	...
	$('#exampleModal').on('show.bs.modal', function (event) {
		...
		var modal = $(this)
		modal.find('.modal-body').html(`<iframe src="view.php?id=${id}" frameborder="0" style="width: 100%; height: 100%;"></iframe>`);
